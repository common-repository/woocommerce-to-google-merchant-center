...
Looking for a way to upload your WooCommerce product (feeds) to world largest online product advertisement platform, Google Merchant Center?
...
<strong>Compatible with WooCommerce 4.5.2 (Latest)</strong>
...
[Buy PRO](https://wpspear.com/product-feed/)
...
* **New** The product related feed will update automatically when product is updated. 
...
* **New** Channel google local product.

= v1.7.4 - April 17, 2019 =

* **Update** Remove html tag from description.
* **Fix** Product price fractional problem.
...
* **New** Feed download link.
* **New** Google shopping feed documentation.
